	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse">
                ...
                <h4 class="panel-title">DAFTAR JABATAN</h4>
				</div>
				<!-- end panel-heading -->
				<!-- begin alert -->
					...
					<table id="data-table-responsive" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td>{{$item->nama}}</td>
								<td> 
									<a href="#" data-nama="{{$item->nama}}" data-id="{{$item->id}}"class="btn btn-primary btn-xs edit-kategori">edit</a>
									<a href="/masterdata/jabatan/{{$item->id}}/delete" class="btn btn-danger btn-xs"  onclick="return confirm('Apakah anda Yakin ingin menghapus Data Ini?');">delete</a>
                                </td>
							</tr>
                            @endforeach
                        </tbody>
					...
					<div class="modal fade" id="modal-dialog">
						<div class="modal-dialog">
							<div class="modal-content">
                                ...
                                <form action="/masterdata/jabatan" method="POST">
                                    @csrf
					...
					<div class="modal fade" id="modal-dialog2">
						<div class="modal-dialog">
							<div class="modal-content">
                                ...
                                <form action="/masterdata/jabatan/update" method="POST">
                                    @csrf
								<div class="modal-body">
									<p>
                                        <div class="form-group row m-b-15">
                                            <label class="col-md-3 col-form-label">Nama Jabatan</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" required  id="nama_jabatan" name="nama">
