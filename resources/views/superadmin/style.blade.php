		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-3">
				...
				<div class="panel-heading">
					...
					<h4 class="panel-title">FRONT PAGE</h4>
				</div>
				<!-- end panel-heading -->
				<!-- begin panel-body -->
				<div class="panel-body panel-form">
					<form class="form-horizontal form-bordered" method="POST" action="/masterdata/style/update"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
							...
							<div class="col-md-8">
                                ...
                                <img src="/storage/{{$data->logo}}" width="100">
							</div>
                        </div>
                        <div class="form-group row">
							<label class="col-md-4 col-form-label">Wallpaper</label>
							<div class="col-md-8">
                                <input class="form-control" type="file" name="wallpaper" value="{{$data->wallpaper}}">
                                <img src="/storage/{{$data->wallpaper}}" width="250">
							</div>
                        </div>
