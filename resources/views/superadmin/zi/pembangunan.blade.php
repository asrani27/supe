						...
						<tbody>
							...
							<tr class="odd gradeX">
                                ...
                                <td>
									...
									<a href="/uploadkomponen/delete/{{$item->upload_id}}" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda Yakin ingin menghapus Data Ini?');">Delete</a> 	
									@endif
                                </td>
							</tr>
                            @endforeach
...
<div class="modal fade" id="modal-dialog">
		<div class="modal-dialog">
			<div class="modal-content">
                ...
                <form action="/zi/pembangunan/skpd/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
...
<div class="modal fade" id="modal-dialog-edit-file">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/uploadkomponen/update/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-isi-nilai">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/uploadkomponen/nilai/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-edit-nilai">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/uploadkomponen/nilai/{{$id_skpd}}/update" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-edit-status">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/zi/pembangunan/ubahstatus" method="POST">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
							...
							<div class="col-md-8">
								...
								<input type="hidden" class="form-control" id="id_uploadkomponen" name="id_uploadkomponen" readonly>
							</div>
						</div>
						<div class="form-group row m-b-15">
...
<script>
	$(document).ready(function() {
		...
		$(document).on('click', '.edit-status', function() {
			$('#id_uploadkomponen').val($(this).data('id'));
