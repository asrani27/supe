	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse">
                ...
                <h4 class="panel-title">DAFTAR KATEGORI PENCANANGAN</h4>
				</div>
				<!-- end panel-heading -->
				<!-- begin alert -->
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td> 
									...
									<a href="/masterdata/kategori/{{$item->id}}/delete" class="btn btn-danger btn-xs"  onclick="return confirm('Apakah anda Yakin ingin menghapus Data Ini?');">delete</a>
                                </td>
							</tr>
                            @endforeach
                        </tbody>
					...
					<div class="modal fade" id="modal-dialog">
						<div class="modal-dialog">
							<div class="modal-content">
                                ...
                                <form action="/masterdata/kategori" method="POST">
                                    @csrf
					...
					<div class="modal fade" id="modal-dialog2">
						<div class="modal-dialog">
							<div class="modal-content">
                                ...
                                <form action="/masterdata/kategori/update" method="POST">
                                    @csrf
								<div class="modal-body">
									<p>
                                        <div class="form-group row m-b-15">
