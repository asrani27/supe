		...
		<div class="col-lg-12">
			...
			<div class="panel panel-inverse">
				...
				<div class="alert alert-secondary fade show">
                    <a href="/wbk" class="btn btn-danger btn-sm">Kembali</a>
                </div>
				<!-- end alert -->
				<!-- begin panel-body -->
						...
						<tbody>
							...
							<tr class="odd gradeX">
                                ...
                                <td>
									...
									<a href="/filewbk/delete/{{$item->upload_id}}" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda Yakin ingin menghapus Data Ini?');">Delete</a> 	
									@endif
                                </td>
							</tr>
                            @endforeach
...
<div class="modal fade" id="modal-dialog">
		<div class="modal-dialog">
			<div class="modal-content">
                ...
                <form action="/wbk/skpd/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
...
<div class="modal fade" id="modal-dialog-edit-file">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/filewbk/update/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-isi-nilai">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/wbk/nilai/{{$id_skpd}}" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-edit-nilai">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/wbk/nilai/{{$id_skpd}}/update" method="POST" enctype="multipart/form-data">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
...
<div class="modal fade" id="modal-dialog-edit-status">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="/wbk/ubahstatus" method="POST">
					@csrf
				<div class="modal-body">
					<p>
						<div class="form-group row m-b-15">
